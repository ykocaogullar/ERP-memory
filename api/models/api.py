...
class ChatRequest(BaseModel):
    ...
    max_tokens: Optional[int] = Field(default=None, ge=1, le=4096, description="Max tokens in response (uses service default if not provided)")
    temperature: Optional[float] = Field(default=None, ge=0.0, le=2.0, description="Sampling temperature (uses service default if not provided)")
